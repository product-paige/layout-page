/* ============================================================
   ...
   Structural reference: a generic operations/consulting homepage.
   Not a clone — neutral placeholder brand "Northwind", placeholder
   media frames, grayscale-first by default.
   ============================================================ */
...
const LP_SECTIONS = [
  {
    ...
    description: "A transparent header over a hero/media background: brand left, primary nav with a hover mega menu, and a CTA on the right.",
    structure: "Brand mark and inline nav on the left (one item opens a mega menu), primary CTA on the right, laid over a media background.",
    ...
    primitives: ["sx-overlay", "sx-wrap", "sx-nav", "sx-navlink", "sx-nav-item", "sx-megamenu", "sx-megamenu-col", "sx-megamenu-promo", "sx-eyebrow", "sx-media", "sx-meta", "sx-btn"],
...

  {
    ...
    description: "A full-bleed media hero with a large content card overlaid on the left and a small floating proof card near the bottom-right.",
    structure: "Media background fills the section. A content card (eyebrow, heading, body, CTA) sits over the left; a small avatar + quote proof card floats lower-right.",
    ...
    copyFit: { eyebrow: "1 short label", heading: "3–8 words (can wrap)", body: "1 short paragraph (15–28 words)", cta: "1 primary button", proof: "avatar/logo + 1 short line" },
    includes: "Eyebrow, heading, body, CTA, floating proof card",
    primitives: ["sx-overlay", "sx-card", "sx-eyebrow", "sx-display", "sx-body", "sx-cta", "sx-btn", "sx-avatar", "sx-meta"],
  ...
  <div class="sx-overlay-content" style="width:100%;display:flex;flex-direction:column;justify-content:space-between;gap:var(--sx-space-6)">
    ...
    claudePrompt: "Use the Hero Media Card 01 structure: full media background, a large content card overlaid on the left (eyebrow, heading, body, one primary CTA), and a small floating proof card lower-right (avatar + one line). Replace copy with mine; keep the heading 3–8 words and body to one short paragraph. Preserve the overlay, the card, and the .sx-* token classes so it re-skins across modes."
  },

  {
    ...
    structure: "Centered label, then a single horizontal row of evenly-spaced monochrome logo placeholders. Wraps on small screens.",
  ...
  <ul class="sx-cluster" style="list-style:none;margin:0;padding:0;justify-content:center;gap:var(--sx-space-6)">
    ...
    claudePrompt: "Use the Logo Proof Strip 01 structure: a centered proof label above a single horizontal row of monochrome logos. Replace the label and swap the placeholders for 4–6 real logos kept monochrome. Preserve the centered layout and the .sx-* token classes."
  },

  {
    ...
    structure: "Left column holds eyebrow, heading, body, and a CTA. Right column is a composed media cluster (tall frame + square frame + a small accent stat card). Stacks below md.",
    structureTags: ["split", "with-media"],
    bestFor: ["Product feature", "Platform overview", "Capability highlight", "Data / analytics"],
    copyFit: { eyebrow: "1 short label", heading: "4–8 words", body: "1 short paragraph", cta: "1 button (optional)" },
    includes: "Eyebrow, heading, body, CTA, media cluster",
    primitives: ["sx-section", "sx-wrap", "sx-split", "sx-eyebrow", "sx-heading", "sx-body", "sx-cta", "sx-btn", "sx-grid", "sx-media", "sx-card"],
  ...
  <div class="sx-wrap sx-split">
    ...
    claudePrompt: "Use the Feature Split 01 structure: text lockup left (eyebrow, heading, body, CTA), composed media cluster right. Replace copy with mine; the right side stays a media composition with one small accent stat card. Keep the split, spacing, and .sx-* token classes so the accent follows the active mode."
  },

  {
    ...
    structure: "Wide media frame on the left, content on the right: eyebrow, heading, body, and a 3-item list of rules/benefits. Stacks below md.",
    ...
    primitives: ["sx-section", "sx-wrap", "sx-split", "sx-media", "sx-eyebrow", "sx-heading", "sx-body", "sx-list", "sx-list-item"],
  ...
  <div class="sx-wrap sx-split sx-split--text-wide">
    ...
    claudePrompt: "Use the Content Image Split 01 structure: a large image on one side, content on the other (eyebrow, heading, body, 3-item list). Replace copy with mine; keep three short list items. Preserve the split, spacing, and .sx-* token classes."
  },

  {
    ...
    structure: "Centered eyebrow + heading, then a 4-up grid of equal cards (icon, title, one-line description). Collapses to 1 column below md.",
    structureTags: ["grid", "cards", "centered"],
    bestFor: ["Services overview", "Capabilities", "Value props", "What we do"],
    copyFit: { eyebrow: "1 short label", heading: "5–10 words", cards: "4 cards · title (1–3 words) + 1 line each" },
    includes: "Eyebrow, heading, 4 cards",
    primitives: ["sx-section", "sx-wrap", "sx-eyebrow", "sx-heading", "sx-grid", "sx-feature", "sx-feature-title", "sx-icon", "sx-meta"],
  ...
  <div class="sx-wrap" style="display:flex;flex-direction:column;gap:var(--sx-space-5)">
    ...
    claudePrompt: "Use the Service Card Grid 01 structure: centered eyebrow + heading, then four equal cards (icon, title, one-line description). Replace copy and icons with mine; keep four cards. Preserve the grid, card style, and .sx-* token classes."
  },

  {
    ...
    description: "An inverse band with a heading, an interactive service accordion + CTA on the left, and a media frame on the right.",
    structure: "Inverse (contrast) band. Heading on top, then a split: left = an accordion of services (click a headline to reveal its description, one open at a time) + CTA, right = media frame. The band flips with the mode.",
    ...
    copyFit: { eyebrow: "1 short label", heading: "4–7 words", items: "3–6 accordion items · headline + 1 line", cta: "1 button" },
    includes: "Heading, 4-item service accordion, CTA, media",
    primitives: ["sx-section", "sx-band--inverse", "sx-wrap", "sx-split", "sx-eyebrow", "sx-heading", "sx-acc", "sx-acc-a", "sx-cta", "sx-btn", "sx-media"],
...

  {
    ...
    structure: "Centered eyebrow + heading, then a 3-up grid of tiles (media frame, small category label, one-line outcome). Collapses to 1 column below md.",
    ...
    primitives: ["sx-section", "sx-wrap", "sx-eyebrow", "sx-heading", "sx-grid", "sx-tile", "sx-tile-media", "sx-feature-title"],
  ...
  <div class="sx-wrap" style="display:flex;flex-direction:column;gap:var(--sx-space-5)">
    ...
    claudePrompt: "Use the Case Study Card Grid 01 structure: centered eyebrow + heading, then three case-study tiles (media, category label, one outcome line). Replace copy and media with mine; keep three tiles. Preserve the grid and .sx-* token classes."
  },

  {
    ...
    structure: "Media background fills the section; a left-aligned large statement and a single CTA sit over it. The statement wraps across lines.",
  ...
  <div class="sx-overlay-content sx-wrap" style="display:flex;flex-direction:column;gap:var(--sx-space-4);margin-inline:0;max-width:60ch">
    ...
    claudePrompt: "Use the Full Bleed Image CTA 01 structure: full-width media with a large left-aligned statement and one small CTA over it. Replace the statement and CTA with mine; keep the statement to one wrapping line of 6–12 words. Preserve the overlay and .sx-* token classes."
  },

  {
    ...
    description: "A section heading with a 'view all' link above three resource/article cards (media, title, summary, small arrow action).",
    structure: "Header row (eyebrow + heading + view-all link), then a 3-up grid of resource cards: media frame, title, one-line summary, and a small arrow link. Collapses to 1 column.",
    structureTags: ["grid", "cards", "with-media"],
    bestFor: ["Insights / blog teaser", "Resource hub", "Latest articles", "Guides"],
    copyFit: { eyebrow: "1 short label", heading: "2–5 words", cards: "3 cards · title + 1 summary line + action" },
    includes: "Eyebrow, heading, view-all link, 3 cards",
    primitives: ["sx-section", "sx-wrap", "sx-between", "sx-eyebrow", "sx-heading", "sx-navlink", "sx-grid", "sx-tile", "sx-tile-media", "sx-feature-title", "sx-meta", "sx-icon"],
  ...
  <div class="sx-wrap" style="display:flex;flex-direction:column;gap:var(--sx-space-5)">
    ...
    claudePrompt: "Use the Resource Card Grid 01 structure: a header row (eyebrow, heading, view-all link) above three resource cards (media, title, one summary line, small arrow link). Replace copy and media with mine; keep three cards. Preserve the grid and .sx-* token classes."
  },

  {
    ...
    description: "A large editorial footer: brand statement and CTA, navigation columns, a legal/social row, and subtle rhythm rules.",
    structure: "Top row: brand statement + CTA. Middle: four nav columns. A divider, then a legal line + social row. Surfaces follow the selected mode.",
    structureTags: ["footer", "columns", "with-cta"],
    bestFor: ["Site footer", "Marketing footer", "Editorial / brand sites"],
    copyFit: { statement: "5–10 words", cta: "1 button", columns: "4 columns · 3–5 links each", legal: "1 line + 3–5 social icons" },
    includes: "Statement, CTA, 4 nav columns, legal/social row",
    primitives: ["sx-section", "sx-band--inverse", "sx-wrap", "sx-between", "sx-heading", "sx-btn", "sx-grid", "sx-eyebrow", "sx-navlink", "sx-divider", "sx-meta", "sx-icon"],
  ...
  <div class="sx-wrap" style="display:flex;flex-direction:column;gap:var(--sx-space-6)">
    ...
    claudePrompt: "Use the Large Editorial Footer 01 structure: a brand statement + CTA on top, four nav columns, a divider, and a legal line + social row. Replace copy and links with mine; keep four columns. Surfaces follow the selected mode; keep the .sx-* token classes."
  }
];

/* ---- Page Layouts: ordered compositions of sections ---- */
const LP_PAGE_LAYOUTS = [
  {
    id: "operational-consulting-homepage-01",
    title: "Operational Consulting Homepage",
    description: "A full homepage for a neutral operations/consulting business, composed entirely from reusable sections and previewable in any Design System + Mode.",
...
if (typeof window !== "undefined") { window.LP_SECTIONS = LP_SECTIONS; window.LP_PAGE_LAYOUTS = LP_PAGE_LAYOUTS; }
if (typeof module !== "undefined") module.exports = { LP_SECTIONS, LP_PAGE_LAYOUTS };
