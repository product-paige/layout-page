/* ============================================================
   layout.page — STYLE SYSTEMS DATA (source of truth)
   Detail pages, the listing, and (later) the Section Library
   System/Mode controls all render from this. Add a new Style
   System = add an object here; nothing else needs rebuilding.
   ============================================================ */

window.LP_STYLE_SYSTEMS = [
  {
    id: "structured-editorial",
    name: "Structured Editorial",
    tagline: "Same structure. New system.",
    description: "A complete grayscale-first Design System: typography, spacing, colors, buttons, cards, labels, forms, and states. Neutral by default, with dark and color modes.",
    summary: "Structured Editorial is inspired by the Lifecycle template's rhythm — not a 1:1 clone. It is a grayscale-first visual framework defined by spacing, typography, borders, rhythm, and layout rather than one brand palette, so it stays generic and reusable across many sites. Neutral is the default; dark is an alternate mode; the color example is optional. Color is a personality layer, not the foundation, so you can judge structure, hierarchy, and rhythm before applying brand expression.",
    tags: ["Editorial","Grayscale","Structured","Typographic","Grid-based","Token-ready","Neutral-first"],
    modes: [
      { id:"neutral", name:"Light", desc:"Default mode. Grayscale-first — judge structure, hierarchy, spacing, and rhythm before any brand color." },
      { id:"dark", name:"Dark", desc:"Alternate mode. The same layout, type, spacing, borders, and rhythm on inverted layout.page surfaces." },
      { id:"color", name:"Color Example", desc:"Optional. One restrained accent shows how the system accepts personality without changing the structure." }
    ],
    bestFor: ["Consulting websites","AI tools","B2B SaaS","Editorial landing pages","Agencies","Portfolio sites","Climate / operations / infrastructure brands","Premium content sites","Founder-led products","Service businesses"],
    personality: ["Calm","Sharp","Structured","Intelligent","Spacious","Precise","Understated","Premium"],
    tokens: {
      colors: {
        neutral: [
      ...
      spacing: [
        { name:"--se-space-1", value:6 }, { name:"--se-space-2", value:12 }, { name:"--se-space-3", value:18 },
        { name:"--se-space-4", value:24 }, { name:"--se-space-5", value:36 }, { name:"--se-space-6", value:48 },
        { name:"--se-space-7", value:72 }, { name:"--se-space-8", value:96 }, { name:"--se-space-9", value:144 },
    ...
    guidelines: {
      do: ["Use oversized headlines with tight line height.","Use bracketed mono labels to create structure.","Use grayscale first.","Use a 6px spacing rhythm.","Use generous section padding.","Use thin borders and grids for structure.","Keep cards restrained and consistent.","Keep body text readable and narrow.","Add personality through token overrides.","Use color sparingly and intentionally.","Preserve the same layout rules across modes."],
      dont: ["Don't make the default mode colorful.","Don't use generic SaaS gradients.","Don't use heavy shadows.","Don't use pill badges everywhere.","Don't make every card a different style.","Don't use random spacing values.","Don't overuse accent color.","Don't use decorative blobs or floating shapes.","Don't make the system feel playful or consumer-app-like.","Don't change layout structure between modes."]
    },
    cssVariables: `:root {
  /* Fonts */
...
[data-mode="color"] {
  ...
  --se-focus-ring: 2px solid var(--se-accent-deep);
    ...
    claudePrompt: "Use the Structured Editorial style system. It is inspired by the Lifecycle template's rhythm but is NOT a 1:1 clone — keep it grayscale-first, generic, and reusable. Use large tight headlines, bracketed mono labels, generous 6px-based spacing, off-white or monochrome backgrounds, thin borders, restrained radius, and structured grids. The style is defined by spacing, typography, borders, rhythm, and layout — not by one brand palette. Neutral is the default; dark is an alternate mode; the color example is optional. Treat color as a personality layer, not the foundation. Preserve the same spacing, typography, hierarchy, and component rules across neutral, dark, and color modes. Avoid generic SaaS gradients, decorative blobs, heavy shadows, pill-heavy UI, or overly branded styling."
  },
  {
    id: "scion",
    name: "Scion",
    tagline: "Dark, premium, precise.",
    description: "A dark, premium system inspired by modern tech and medical templates — Geist with a Newsreader serif accent, an electric-blue highlight, pill buttons, and softly rounded cards.",
    tags: ["Dark","Premium","Tech","Geist","Serif accent","Pill buttons","Rounded"],
    href: "section-library.html",
    modes: [
      { id:"neutral", name:"Default", desc:"Scion's dark base — near-black surfaces, electric-blue accent, pill buttons." }
    ]
  }
];

/* Model stubs for later phases (Section Library + Page Layouts read these) */
window.LP_PAGE_LAYOUTS = [
  { id:"ai-tool-landing-page", title:"AI Tool Landing Page",
    sections:["header-simple-01","hero-split-01","social-proof-logo-strip-01","feature-grid-01","pricing-three-tier-01","faq-accordion-01","cta-centered-01","footer-simple-01"] }
];
